      ...
      body: SingleChildScrollView(
        ...
        child: BlocListener<AuthBloc, AuthState>(
          listener: (context, state) {
            ...
            } else if (state.success && state.message == "Email đặt lại mật khẩu đã được gửi") {
              Navigator.push(
                context,
            ...
            builder: (context, state) {
              return Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5),
                  const Text('Khôi phục mật khẩu', style: TextStyle(fontSize: 16, color: Colors.black87)),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: state.isLoading
                                  ...
                                  : const Text('Gửi yêu cầu', style: TextStyle(fontSize: 17, color: Colors.white)),
                            ),
                          ),
                        ],
                      ),

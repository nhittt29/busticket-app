...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<HomeBloc>().add(LoadUpcomingTripEvent()); // Load upcoming trip
        ...
        appBar: AppBar(
          ...
          title: BlocBuilder<HomeBloc, HomeState>(
            builder: (context, state) {
              final userName = state.user?['name'] ?? 'BusTicket';
              return Row(
                ...
                children: [
                  ...
                  Text(
                    state.user != null ? "Xin chào, $userName" : "BusTicket",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text("Tuyến phổ biến", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black87)),
                        ),
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              _buildPopularRouteCard(context, "Hà Nội", "Sapa", "250.000đ", "assets/images/sapa.png"),
                              _buildPopularRouteCard(context, "TP.HCM", "Đà Lạt", "300.000đ", "assets/images/dalat.png"),
                              _buildPopularRouteCard(context, "Đà Nẵng", "Hội An", "50.000đ", "assets/images/hoian_fixed.png"),
                            ],
                          ),
                        ),
  ...
  Widget _buildPopularRouteCard(BuildContext context, String from, String to, String price, String imagePath) {
    return Container(
      width: 140,

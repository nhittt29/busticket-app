      ...
      body: BlocListener<AuthBloc, AuthState>(
        listener: (context, state) {
          if (state.success && state.message != null) {
            ...
            // Chuyển về màn hình trước đó sau khi lưu thành công
        ...
        child: SingleChildScrollView(
          ...
          child: Form( // Bọc toàn bộ nội dung trong Form
            child: Column(
              ...
              children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          try {
                            ...
                            print('Validated dob: $value');
                          } catch (e) {
                            print('Validation error for dob: $e');
                ...
                const SizedBox(height: 30),
                Builder( // Sử dụng Builder để cung cấp context đúng
                  builder: (context) => SizedBox(
                    width: double.infinity,
                    child: ElevatedButton(
                      onPressed: () {
                        print('Button pressed, validating form...');
                        if (Form.of(context)?.validate() ?? false) {
                          ...
                          print('Sending UpdateUserEvent with name: ${nameController.text}, phone: ${phoneController.text}, dob: $dob, gender: $backendGender, avatarPath: ${_newAvatarFile?.path}');

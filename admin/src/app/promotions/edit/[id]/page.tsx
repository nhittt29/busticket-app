...
const formSchema = z.object({
    ...
    usedCount: z.coerce.number().optional(),
...
export default function PromotionEditPage() {
    ...
    const { onFinish, handleSubmit, control, formState, refineCore } = form;
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Chỉnh sửa khuyến mãi</h1>
                    <p className="text-muted-foreground text-sm">Cập nhật thông tin chương trình khuyến mãi</p>
                </div>
            </div>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="VD: TET2025" {...field} className="uppercase font-medium" disabled />
                                            </FormControl>
                                            <FormDescription>Mã khuyến mãi không thể thay đổi.</FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                />
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm">
                                            <div className="space-y-0.5">
                                                <FormLabel className="text-base">Đang hoạt động</FormLabel>
                                                <FormDescription>
                                                    Tắt để tạm dừng chương trình này.
                                                </FormDescription>
                                            </div>
                                            <FormControl>
                                                <Switch
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="number" {...field} disabled className="bg-muted" />
                                            </FormControl>
                                            <FormDescription>Số lần mã này đã được áp dụng.</FormDescription>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                />
